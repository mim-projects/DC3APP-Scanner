...
public class PermisoTrabajo implements Serializable {
    ...
    private Boolean firmadoPrimera;
    ...
    public Boolean getFirmadoPrimera() {
        return firmadoPrimera;
    }

    public void setFirmadoPrimera(Boolean firmadoPrimera) {
        this.firmadoPrimera = firmadoPrimera;
    }
